      ...
      <Row>
        ...
        <Cell desktopColumns={6} phoneColumns={4} tabletColumns={6}>
          <div style={{ padding: '32px 0px' }}>
            <h1 style={{ textAlign: 'center', paddingBottom: '16pxpx' }}>Sign Up</h1>
            <div>
              <TextField
                outlined
                label='First name'
            ...
            {
              uiStatus.isLoading ? (<Button disabled={true}>Sign Up</Button>) : (<Button onClick={tryToSignUp}>Sign Up</Button>)
            }
          </div>
        </Cell>
        <Cell desktopColumns={3} phoneColumns={0} tabletColumns={1}></Cell>
